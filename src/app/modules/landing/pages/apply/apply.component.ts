        ...
        this.studentHistoryService
          ...
          .subscribe((res: any) => {
            if (res.length == 0) {
              ...
              const largestId = res.reduce((prev: any, curr: any) => (curr.historyId > prev.historyId ? curr : prev), res[0])  
              let year = '';
              let term = '';
              
              if (largestId.yearLevel == 'First Year' && largestId.sem == 'First Term') {
                year = 'First Year';
                term = 'Second Term';

                this.levels.push(year);
                this.terms.push(term);
              } else if (largestId.yearLevel == 'First Year' && largestId.sem == 'Second Term') {
                year = 'Second Year';
                term = 'First Term';

                this.levels.push(year);
                this.terms.push(term);
              } else if (largestId.yearLevel == 'Second Year' && largestId.sem == 'First Term') {
                year = 'Second Year';
                term = 'Second Term';

                this.levels.push(year);
                this.terms.push(term);
              } else if (largestId.yearLevel == 'Second Year' && largestId.sem == 'Second Term') {
                year = 'Third Year';
                term = 'First Term';

                this.levels.push(year);
                this.terms.push(term);
              } else if (largestId.yearLevel == 'Third Year' && largestId.sem == 'First Term') {
                year = 'Third Year';
                term = 'Second Term';

                this.levels.push(year);
                this.terms.push(term);
              } else if (largestId.yearLevel == 'Third Year' && largestId.sem == 'Second Term') {
                year = 'Fourth Year';
                term = 'First Term';

                this.levels.push(year);
                this.terms.push(term);
              } else if (largestId.yearLevel == 'Fourth Year' && largestId.sem == 'First Term') {
                year = 'Fourth Year';
                term = 'Second Term';
